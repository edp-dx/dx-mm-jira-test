...
**Homepage:** <https://github.com/edp-dx/dx-mm-jira-test>
...
* <https://github.com/edp-dx/dx-mm-jira-test>
...
| framework | string | `"springboot"` |  |
| fullnameOverride | string | `""` |  |
| image.pullPolicy | string | `"IfNotPresent"` |  |
| image.repository | string | `"mm-jira-test"` |  |
